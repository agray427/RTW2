...
public final class UserProfile {
    ...
    public UserProfile(@NonNull Entity<GroupUser> entity) {
        this(entity.getId(), entity.getData());
    }

    public UserProfile(@NonNull String userId, @NonNull GroupUser data) {
    ...
    public UserProfile(@NonNull String userId, @NonNull String userName, @NonNull String points) {
        this.userId = userId;
